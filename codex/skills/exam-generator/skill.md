...
参考约束模板：`${CODEX_PLUGIN_ROOT}/skills/exam-generator/examples/exam-constraints.md`
...
LaTeX 模板参考：`${CODEX_PLUGIN_ROOT}/skills/exam-generator/templates/exam-template.tex`
答题卡模板参考：`${CODEX_PLUGIN_ROOT}/skills/exam-generator/templates/answer-sheet-template.tex`
