...
```
${CLAUDE_PLUGIN_ROOT}/skills/database-access/scripts/da.py
${CLAUDE_PLUGIN_ROOT}/skills/database-access/scripts/requirements.txt
```
...
```bash
pip install -r "${CLAUDE_PLUGIN_ROOT}/skills/database-access/scripts/requirements.txt"
```
...
```bash
DA="${CLAUDE_PLUGIN_ROOT}/skills/database-access/scripts/da.py"
